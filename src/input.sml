...
fun splitInput [] (funs, rules, problem) = (rev funs, rev rules, hd problem)
  | splitInput (line::rest) (funs, rules, problem) = if String.isPrefix "fun" line then splitInput rest (line::funs, rules, problem)
							  else if String.isPrefix "rule" line then splitInput rest (funs, line::rules, problem)
							  else if String.isPrefix "infeasible?" line then splitInput rest (funs, rules, line::problem)
							  else splitInput rest (funs, rules, problem)
...
fun read filename =
	...
	val (funs, rules, problem) = splitInput lines ([],[],[])
